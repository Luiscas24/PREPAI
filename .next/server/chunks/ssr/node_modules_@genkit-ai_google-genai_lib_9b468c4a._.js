...
function isGoogleSearchRetrievalTool(tool) {
    return tool.googleSearchRetrieval !== void 0 || tool.googleSearch !== void 0 || tool.google_search !== void 0;
}
...
"[project]/node_modules/@genkit-ai/google-genai/lib/common/interaction-converters.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
function toInteractionRole(role) {
    switch(role){
        ...
        case "tool":
            return "user";
        case "system":
            throw new Error(`System role should be handled as system_instruction, not part of turns.`);
        default:
            return "user";
    }
}
...
"[project]/node_modules/@genkit-ai/google-genai/lib/googleai/deep-research.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
var import_interaction_converters = __turbopack_context__.r("[project]/node_modules/@genkit-ai/google-genai/lib/common/interaction-converters.js [app-rsc] (ecmascript)");
var import_utils = __turbopack_context__.r("[project]/node_modules/@genkit-ai/google-genai/lib/common/utils.js [app-rsc] (ecmascript)");
...
const DeepResearchConfigSchema = import_genkit.z.object({
    ...
    thinkingSummaries: import_genkit.z.enum([
        "AUTO",
        "NONE"
    ]).describe("Whether to include thought summaries in the response.").optional(),
    previousInteractionId: import_genkit.z.string().describe("The ID of the previous interaction, if any.").optional(),
    store: import_genkit.z.boolean().describe("Whether to store the response and request for later retrieval.").optional(),
...
const KNOWN_MODELS = {
    "deep-research-pro-preview-12-2025": commonRef("deep-research-pro-preview-12-2025")
};
...
function defineModel(name, pluginOptions) {
    ...
    return (0, import_plugin.backgroundModel)({
        ...
        configSchema: ref.configSchema,
        async start (request) {
            const { apiKey: apiKeyConfig, baseUrl, apiVersion, thinkingSummaries, previousInteractionId, store, responseModalities, ...rest } = request.config || {};
            ...
            if (request.output?.format === "json" || request.output?.contentType === "application/json") {
                ...
                if (request.output.schema) {
                    responseFormat = (0, import_utils.cleanSchema)(request.output.schema);
                }
            }
            let responseModalitiesConverted;
            if (responseModalities) {
                responseModalitiesConverted = responseModalities.map((m)=>m.toLowerCase());
            }
            const req = {
        ...
        async cancel (operation) {
            ...
            const response = await (0, import_client.cancelInteraction)(apiKey, operation.id, cancelOptions);
...
const GeminiImageConfigSchema = GeminiConfigSchema.extend({
    ...
    }).describe("Retrieve public web data for grounding, powered by Google Search.").passthrough().optional()
}).passthrough();
...
const KNOWN_IMAGE_MODELS = {
    "gemini-3.1-flash-image-preview": commonRef("gemini-3.1-flash-image-preview", {
...
function defineModel(name, pluginOptions) {
    ...
    return (0, import_plugin.model)({
        ...
        const { apiKey: apiKeyFromConfig, safetySettings: safetySettingsFromConfig, codeExecution: codeExecutionFromConfig, version: versionFromConfig, functionCallingConfig, googleSearchRetrieval, google_search, fileSearch, urlContext, tools: toolsFromConfig, ...restOfConfigOptions } = requestOptions;
...
var import_client = __turbopack_context__.r("[project]/node_modules/@genkit-ai/google-genai/lib/googleai/client.js [app-rsc] (ecmascript)");
var import_utils2 = __turbopack_context__.r("[project]/node_modules/@genkit-ai/google-genai/lib/googleai/utils.js [app-rsc] (ecmascript)");
var deepResearch = __toESM(__turbopack_context__.r("[project]/node_modules/@genkit-ai/google-genai/lib/googleai/deep-research.js [app-rsc] (ecmascript)"));
...
//# sourceMappingURL=node_modules_%40genkit-ai_google-genai_lib_9b468c4a._.js.map